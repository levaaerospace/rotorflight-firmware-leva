...
static pidAxisCoef_t altitudePidCoeffs;
//static pidCoefficient_t positionPidCoeffs;
static pidAxisCoef_t positionPidCoeffs;
...
typedef struct autopilotState_s {
    ...
    pt3Filter_t upsampleLpfBF[XY_AXIS_COUNT];    // upsampling filter
...
float autopilotAngle[XY_AXIS_COUNT];
...
bool positionControl(void)
{
    ...
    for (unsigned i = 0; i < XY_AXIS_COUNT; i++) {
